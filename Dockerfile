...
RUN (mkdir -p /build/flux-file-storage-api/libs/flux-autoload-api && cd /build/flux-file-storage-api/libs/flux-autoload-api && wget -O - https://github.com/fluxfw/flux-autoload-api/releases/download/v2022-12-12-1/flux-autoload-api-v2022-12-12-1-build.tar.gz | tar -xz --strip-components=1 && /flux-namespace-changer/bin/change-namespace.php . FluxAutoloadApi FluxFileStorageApi\\Libs\\FluxAutoloadApi)
